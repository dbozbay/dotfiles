...
hi BlinkIndent guifg=#b3b3b3 guibg=NONE gui=NONE cterm=NONE
hi BlinkIndentScope guifg=#b3b3b3 guibg=NONE gui=NONE cterm=NONE
hi GitSignsAdd guifg=#008000 guibg=NONE gui=NONE cterm=NONE
hi GitSignsChange guifg=#f3b63c guibg=NONE gui=NONE cterm=NONE
hi GitSignsDelete guifg=#800000 guibg=NONE gui=NONE cterm=NONE
hi GitSignsTopDelete guifg=#800000 guibg=NONE gui=NONE cterm=NONE
hi GitSignsChangeDelete guifg=#f3b63c guibg=NONE gui=NONE cterm=NONE
hi GitSignsUntracked guifg=#b3b3b3 guibg=NONE gui=NONE cterm=NONE
...
hi SignColumn guifg=#000000 guibg=#f6f6f6 gui=NONE cterm=NONE
...
hi SpellRare guifg=#800000 guibg=#ffffff guisp=#800000 gui=undercurl cterm=undercurl
...
if s:t_Co >= 256
  ...
  hi BlinkIndent ctermfg=249 ctermbg=NONE cterm=NONE
  hi BlinkIndentScope ctermfg=249 ctermbg=NONE cterm=NONE
  hi GitSignsAdd ctermfg=28 ctermbg=NONE cterm=NONE
  hi GitSignsChange ctermfg=214 ctermbg=NONE cterm=NONE
  hi GitSignsDelete ctermfg=88 ctermbg=NONE cterm=NONE
  hi GitSignsTopDelete ctermfg=88 ctermbg=NONE cterm=NONE
  hi GitSignsChangeDelete ctermfg=214 ctermbg=NONE cterm=NONE
  hi GitSignsUntracked ctermfg=249 ctermbg=NONE cterm=NONE
  ...
  hi SpellRare ctermfg=88 ctermbg=231 cterm=undercurl
...
if s:t_Co >= 8
  ...
  hi BlinkIndent ctermfg=DarkGrey ctermbg=NONE cterm=NONE
  hi BlinkIndentScope ctermfg=DarkGrey ctermbg=NONE cterm=NONE
  hi GitSignsAdd ctermfg=DarkGreen ctermbg=NONE cterm=NONE
  hi GitSignsChange ctermfg=DarkYellow ctermbg=NONE cterm=NONE
  hi GitSignsDelete ctermfg=DarkRed ctermbg=NONE cterm=NONE
  hi GitSignsTopDelete ctermfg=DarkRed ctermbg=NONE cterm=NONE
  hi GitSignsChangeDelete ctermfg=DarkYellow ctermbg=NONE cterm=NONE
  hi GitSignsUntracked ctermfg=DarkGrey ctermbg=NONE cterm=NONE
  ...
  hi SpellRare ctermfg=DarkRed ctermbg=White cterm=undercurl
